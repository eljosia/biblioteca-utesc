...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $users = array(
            ...
            array('id' => '2', 'user' => '201900262', 'name' => 'José Angel', 'last_n' => 'Rodriguez', 'email' => 'eljosia.rc@gmail.com', 'rol' => 'A', 'email_verified_at' => NULL, 'password' => '$2y$10$3ryuXAAu6oxsPqVy8Y037Or2GZEs7r8N3VN4dk2e0gD9VYDapqEtK', 'remember_token' => NULL, 'created_at' => NULL, 'updated_at' => NULL),
            ...
            array('id' => '4', 'user' => 'sanata', 'name' => 'sanata', 'last_n' => 'kamal', 'email' => 'delab70433@hrisland.com', 'rol' => 'A', 'email_verified_at' => NULL, 'password' => '$2y$10$RL4kqX4tveRMU4ypcHrgz..a.FwJTdiRxenfKpIRQkOG1PLxHkQFa', 'remember_token' => NULL, 'created_at' => '2023-04-21 02:07:27', 'updated_at' => '2023-04-21 02:07:27')
        );
        ...
        DB::table('clasifications')->insert($clasifications);
    }
}
